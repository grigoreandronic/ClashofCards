...
package com.unitn.clashofcards.marketplace
...
class CheckoutActivity : AppCompatActivity() {
    ...
    private lateinit var deckList: JSONArray
    private lateinit var selectedDeck: JSONObject
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(com.unitn.clashofcards.R.layout.activity_checkout)

        // Set up the mock information for our item in the UI.
        selectedDeck = fetchRandomDeck()
    ...
    private fun requestPayment() {
        ...
        val garmentPriceMicros = (selectedDeck.getDouble("price") * 1000000).roundToLong()
    ...
    private fun handlePaymentSuccess(paymentData: PaymentData) {
        ...
        try {
            ...
            Toast.makeText(this, getString(com.unitn.clashofcards.R.string.payments_show_name, billingName), Toast.LENGTH_LONG).show()
