...
import com.unitn.clashofcards.RegistrationActivity
import com.unitn.clashofcards.model.Deck


class DeckAdapter(var context: Context, var arrayList: ArrayList<Deck>) :
    RecyclerView.Adapter<DeckAdapter.ItemHolder>() {
