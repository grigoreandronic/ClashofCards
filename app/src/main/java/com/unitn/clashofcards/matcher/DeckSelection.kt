...
import com.unitn.clashofcards.adapters.DeckSelectionAdapter
import com.unitn.clashofcards.model.Deck

class DeckSelection: AppCompatActivity() {
  // [START declare_database_ref]

  private var recyclerView: RecyclerView? = null
  private var charItem: MutableList<Deck>? = null
  private var gridLayoutManager: GridLayoutManager? = null
  private var alphaAdapters: DeckSelectionAdapter? = null
            ...
            it.get()
              .addOnSuccessListener { document ->
                if (document != null) {
                  ...
                  if(deck!=null){
                    charItem!!.add(deck)
                    alphaAdapters = DeckSelectionAdapter(applicationContext, ArrayList(charItem!!))
